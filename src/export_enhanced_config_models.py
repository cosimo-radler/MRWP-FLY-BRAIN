...
def save_enhanced_network(G, network_type):
    ...
    Args:
        ...
        network_type: Type of network for naming
    """
    output_path = os.path.join(ENHANCED_MODELS_DIR, f"{network_type}_enhanced_config_model.gexf")
    nx.write_gexf(G, output_path)
    print(f"Saved enhanced configuration model to {output_path}")
