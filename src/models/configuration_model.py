...
def save_network(G, network_type):
    """Save configuration model network to GEXF file.
    
    Args:
        G: NetworkX DiGraph of the configuration model
        network_type: Type of network for naming
    """
    ...
    nx.write_gexf(G, config_path)
    nx.write_gexf(G, gephi_path)
    
    print(f"Configuration model saved to {config_path} and {gephi_path}")
